...
using SalesWebMVCUI.Models.Enums;
...
namespace SalesWebMVCUI.Data
{
    public class SeedingService
    {
        ...
        public SeedingService(SalesWebMVCUIContext context)
        {
            _context = context;
        }
        ...
        public void Seed()
        {
            ...
            Seller s6 = new Seller(6, "Alex Pink", "bob@gmail.com", new DateTime(1997, 3, 4), 3000, d2);
